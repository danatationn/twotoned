a simplistic skin with no heavy editing
its gimmick is that most of the skin elements are bright on the top and dark on the bottom
...
[*] [url=https://fonts.google.com/specimen/Lexend]Lexend[/url] - the main font used
[*] [url=https://github.com/ppy/osu-resources/tree/master/osu.Game.Resources/Samples/Gameplay/ArgonPro]Argon Pro[/url] - nabbed the hitsounds from this. is also one of the lazer skins :p
[*] [url=https://www.reddit.com/r/DDLCMods/comments/t49e4e/exit_music_redux_11_release/]Exit Music: Redux[/url] - the 2 main menu sounds and the pause loop
[*] [url=https://u-he.com/products/diva/]Diva[/url] - used to make some of the menu sounds
[/list]
...
[box=nightly version]
[list]
[*]click on the [url=https://github.com/danatationn/twotoned/archive/refs/heads/the-actual-skin.zip]nightly github[/url] link 
[*]this will provide you with a zip file called [c]twotoned-the-actual-skin.zip[/c]
[*]this is fine! you just need to rename the [c].zip[/c] part with [c].osk[/c], osu's skin extension (yes they're just zip files lol)
[*]you can also remove the [c]-the-actual-skin[/c] part it's no biggie
